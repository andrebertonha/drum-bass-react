...
class DrumPad extends Component {
  ...
  activePad() {
    if(this.props.power) {
      this.state.padStyle.backgroundColor === 'green' ? 
        this.setState({
          padStyle: inactiveStyle
        }) :
        this.setState({
  ...
  render() {
    ...
    return (
      <div id="drum-machine" className="inner-container">
        ...
        />
        <div className="logo">
          <div className="inner-logo">{'DRUMMER BASS' + String.fromCharCode(160)}</div>
